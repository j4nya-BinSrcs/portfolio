...
// Java has no simple-icons entry that looks right at small sizes, so we ship a
// hand-tuned inline SVG (viewBox 128) and render it via MULTI instead of BRANDS.
const JAVA_LOGO_SVG =
...
// Multi-path logos (viewBox 128) take precedence over BRANDS; WORDMARKS render
// the name as styled text. BRANDS = single-path simple-icons in viewBox 24.
...
// Hover scaling via motion values + a spring: scale ramps up with pointer
// proximity so the tile "lifts" toward the cursor (macOS-dock style).
